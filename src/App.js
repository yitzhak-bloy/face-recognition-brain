...
class App extends Component {
  ...
  onButtonSubmit = () => {
    this.setState({imageUrl: this.state.input});
      fetch('https://quiet-caverns-30560.herokuapp.com/imageurl',  {
        method: 'post',
      ...
      .then(response => {
        if (response) {
          fetch('https://quiet-caverns-30560.herokuapp.com/image',  {
            method: 'put',
            headers: {'Content-Type': 'application/json'},
            body: JSON.stringify({
    ...
    return (
      <div className="App">
        ...
        { route === 'home'
          ? <div>
              <Logo />
              <Rank name={this.state.user.name} entries={this.state.user.entries} language={this.state.language} />
              <ImageLinkForm 
